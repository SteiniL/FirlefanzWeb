    ...
    <div class="overflow-x-clip">
        ...
        <section class="relative bg-gray-300 text-black">
            ...
            <div class="relative z-10 -mt-[100vh]">
                ...
                >
                    <h1 class="font-salted text-5xl">Datenschutz</h1>
                    <p
                        class="font-FuturaCondMedium text-d-mid pt-5 text-left text-3xl"
                    >
                        Firlefanz website is owned by Firlefanz n.e.V., which is
                        a data controller of your personal data.<br />

                        We have adopted this Privacy Policy, which determines
                        how we are processing the information collected by
                        Firlefanz, which also provides the reasons why we must
                        collect certain personal data about you. Therefore, you
                        must read this Privacy Policy before using Firlefanz
                        website.<br />
                        We take care of your personal data and undertake to
                        guarantee its confidentiality and security.<br /><br />
                        <b>Personal information we collect:</b><br />
                        When you visit the Firlefanz, we automatically collect
                        ...
                        during registration to be able to fulfill the
                        agreement.<br /><br />
                        <b>Why do we process your data?</b><br />
                        ...
                        kontakt@firlefanz-festival.com.<br /><br />
                        <b>Your rights:</b><br />
                        If you are a European resident, you have the following
                        rights related to your personal data:<br />
                    </p>
                    <ul
                        class="font-FuturaCondMedium text-d-mid list-inside list-disc pt-5 text-left text-3xl"
                    >
                    ...
                    >
                        ...
                        us through the contact information below.<br /><br />
                        ...
                        the Internet or wireless network can be guaranteed.<br /><br />
                        ...
                        kontakt@firlefanz-festival.com.
                    </p>
                </div>
            </div>
