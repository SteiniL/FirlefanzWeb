<template>
    <footer class="group mt-[50dvh] bg-slate-950 text-white">
        ...
        <section class="relative z-10 rounded-t-[30vw] bg-black">
            <div class="mx-auto max-w-6xl px-6 pt-12 pb-10">
                ...
                <div class="grid grid-cols-2 items-center gap-10">
                    ...
                    <div class="">
                        ...
                        <p class="mt-3 text-xs text-white/70">
                            Du möchtest keinen Firlefanz verpassen?<br />
                            Dann abonniere uns auf
                            <a
                                href="https://www.instagram.com/firlefanz.festival/"
                            ...
                            oder
                            <a
                                href="https://t.me/firlefanzfestival"
                                class="fx-link text-white"
                                >Telegram</a
                            >
                        </p>
                ...
                <!-- Bottom -->
                <div
                    class="mt-10 flex-col items-center border-t border-white/10 pt-6"
                >
                    <div class="">
                        <p
                            class="mx-auto w-full text-center text-sm text-white/60"
                        >
